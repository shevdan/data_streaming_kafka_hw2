...
VIDEO_FILE       = os.getenv('VIDEO_FILE')      # "vid_01.mp4"
...
if __name__ == '__main__':
    logger.info(f"configuration: dataset_root_dir={DATASET_ROOT_DIR!r}, vid_subdir={VID_SUBDIR!r}, video_file={VIDEO_FILE!r}")
    if not DATASET_ROOT_DIR or not VIDEO_FILE:
